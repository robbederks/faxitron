/*
 ## Cypress USB 3.0 Platform header file (cyu3tx.h)
 ## ===========================
 ##
...
/*
 * Summary
 * The file define the ThreadX RTOS abstraction layer for FX3 devices
 * For details about these functions, refer to the ThreadX user guide and the tx_api.h
 * No functions in tx_api.h shall be called directly (without the wrappers provided in 
 * cyu3os.h) from the firmware API library. This header file together with cyu3tx.c 
 * provides the RTOS porting for the API library.
 */
...
/* Summary
   DMA buffer manager for the FX3 devices.

   Description
   Firmware application for the FX3 devices require a number of buffers
