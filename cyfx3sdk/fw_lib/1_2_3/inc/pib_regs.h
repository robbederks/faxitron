...
typedef struct
{
    ...
    uvint32_t wr_threshold;                       /* 0xe001002c */
    uvint32_t rd_threshold;                       /* 0xe0010030 */
    uvint32_t rsrvd0[4083];
    ...
    uvint32_t pp_identification;                  /* 0xe0017e0c */
    uvint32_t pp_wr_threshold;                    /* 0xe0017e10 */
    uvint32_t pp_rd_threshold;                    /* 0xe0017e14 */
    ...
    uvint32_t sram_control;                       /* 0xe0017f08 */
    uvint32_t rsrvd4[61];
    struct
    {
    ...
    uvint32_t rsrvd8[53];
    uvint32_t adapter_debug;                      /* 0xe001fff4 */
    uvint32_t adapter_conf;                       /* 0xe001fff8 */
    uvint32_t adapter_status;                     /* 0xe001fffc */
...
/*
   Mailbox message from Benicia to Application Processor.
 */
...
/*
   Mailbox message from Application Processor to Benicia
 */
...
/*
   ...
   ASYNC: 0xF  (default)
   SYNC: FW/BL to copy from efuse field SYNCIF_CORE_PHASE
   PMMC: FW/BL to copy from efuse field PMMC_CORE_PHASE
 */
...
/*
   ...
   This field is not required for SYNC and PMMC interfaces modes,
 */
...
/*
   ...
   ASYNC: 0xF  (default)
   SYNC: FW/BL to copy from efuse field SYNCIF_OUT_PHASE
   PMMC: FW/BL to copy from efuse field PMMC_OUT_PHASE
 */
...
/*
   ...
   001 DLL is in Bypass Mode. DLL input clock is bypassed to outputs.
   010 Lock detect DFT mode. The dllrdy signal is monitored on the designated
   GPIO in clock_observation_mode
   011 Phase Comparator DFT #1. The used dll_out signals are available to
   be monitored on TDO pin in clock_observation_mode
   100 Scan test : monitor test_so. This mode is not allowed for selection
   through register control.
   101 Phase Comparator DFT #2 : The used dll_out signals are available to
   be monitored on TDO pin in clock_observation_mode
   110 Error code reset : The error_code[1:0] output of the dll is available
   for monitoring on the designated GPIO in clock_observation_mode
   111 This setting is used either for fault grading or monotonicity test
   based on the settings of the "mode" input.
          DLL_MODE =0: used for fault grading, DLL's phase comparator drives
   dllrdy which is available for monitoring on the designated GPIO in clock_observation_mode
          DLL_MODE =1: Monotonicity test : The used dll_out signals are available
   to be monitored on TDO pin in clock_observation_mode
 */
...
/*
   Write Threshold
 */
#define CY_U3P_PIB_WR_THRESHOLD_ADDRESS                     (0xe001002c)
#define CY_U3P_PIB_WR_THRESHOLD                             (*(uvint32_t *)(0xe001002c))
#define CY_U3P_PIB_WR_THRESHOLD_DEFAULT                     (0x00000000)

/*
   CPU writes to this field during initialization. Value written to this
   register is made available by HW in PP_WR_THRESHOLD register. When AP
   writes to PP_WR_THRESHOLD register this register gets updated with the
   new value and WR_THRESHOLD interrupt is provided.
 */
#define CY_U3P_PIB_VALUE16_MASK                             (0x0000ffff) /* <0:15> RW:RW:0:Yes */
#define CY_U3P_PIB_VALUE16_POS                              (0)
...
/*
   Read Threshold
 */
#define CY_U3P_PIB_RD_THRESHOLD_ADDRESS                     (0xe0010030)
#define CY_U3P_PIB_RD_THRESHOLD                             (*(uvint32_t *)(0xe0010030))
#define CY_U3P_PIB_RD_THRESHOLD_DEFAULT                     (0x00000000)

/*
   CPU writes to this field during initialization. Value written to this
   register is made available by HW in PP_RD_THRESHOLD register. When AP
   writes to PP_RD_THRESHOLD register this register gets updated with the
   new value and RD_THRESHOLD interrupt is provided.
 */
#define CY_U3P_PIB_VALUE16_MASK                             (0x0000ffff) /* <0:15> RW:RW:0:Yes */
#define CY_U3P_PIB_VALUE16_POS                              (0)
...
/*
   P-port NoTA identification register
 */
#define CY_U3P_PIB_PP_IDENTIFICATION_ADDRESS                (0xe0017e0c)
#define CY_U3P_PIB_PP_IDENTIFICATION                        (*(uvint32_t *)(0xe0017e0c))
#define CY_U3P_PIB_PP_IDENTIFICATION_DEFAULT                (0x00000081)

/*
   This is a read only field for P-port host. This indicates NoTA L_IN over
   pmmc VERSION. The value is same as PMMC_CONFIG.NOTA_VERSION
 */
#define CY_U3P_PIB_VERSION_MASK                             (0x000000ff) /* <0:7> RW:R:0x81:No */
#define CY_U3P_PIB_VERSION_POS                              (0)


/*
   This register is used for detecting that MMC L_IN is in use. It is first
   written with and read back. The following transformation function is applied
   to read data by MMC L_IN HW block. Dr(7) = Dw(0) xor Dw(6)
   Dr(6) = Dw(7) xor Dw(5)
   Dr(5) = Dw(6) xor Dw(4)
   Dr(4) = Dw(5) xor Dw(3)
   Dr(3) = Dw(4) xor Dw(2)
   ...
   Dr(1) = Dw(2) xor Dw(0)
   Dr(0) = Dw(1) xor Dw(7)
   In the detection phase the register should be written at
   least two different values of data that must generate
   different responses. The transformation function is
   applied in order to differ from memory behaviour.
 */
#define CY_U3P_PIB_IDENTIFICATION_MASK                      (0x0000ff00) /* <8:15> RW:R:0:No */
#define CY_U3P_PIB_IDENTIFICATION_POS                       (8)



/*
   P-port PMMC write threshold
 */
#define CY_U3P_PIB_PP_WR_THRESHOLD_ADDRESS                  (0xe0017e10)
#define CY_U3P_PIB_PP_WR_THRESHOLD                          (*(uvint32_t *)(0xe0017e10))
#define CY_U3P_PIB_PP_WR_THRESHOLD_DEFAULT                  (0x00000000)

/*
   Write buffer free event threshold as number bytes free. After reset this
   register will have maximum threshold value supported by subsystem.
   See PIB_WR_THRESHOLD register description.
 */
#define CY_U3P_PIB_WR_THRESHOLD_MASK                        (0x0000ffff) /* <0:15> RW:R:0:No */
#define CY_U3P_PIB_WR_THRESHOLD_POS                         (0)



/*
   P-port PMMC read threshold
 */
#define CY_U3P_PIB_PP_RD_THRESHOLD_ADDRESS                  (0xe0017e14)
#define CY_U3P_PIB_PP_RD_THRESHOLD                          (*(uvint32_t *)(0xe0017e14))
#define CY_U3P_PIB_PP_RD_THRESHOLD_DEFAULT                  (0x00000000)

/*
   Read buffer data available event threshold as a number bytes available.
   Please note that device side must have the intelligence to activate interrupt
   either this threshold is exceeded or when it sees it useful (end of packet).
   Setting RD_THRESHOLD to 0 will disable threshold
   function. After reset this register will have maximum threshold value
   supported by subsystem.
   See PIB_RD_THRESHOLD description.
 */
#define CY_U3P_PIB_RD_THRESHOLD_MASK                        (0x0000ffff) /* <0:15> RW:R:0:No */
#define CY_U3P_PIB_RD_THRESHOLD_POS                         (0)
...
/*
   0: Read (Transfer from Bay – Egress direction)
...
/*
   0: No wakeup event
   1: Bay returned from standby mode, signal must be cleared by software
 */
#define CY_U3P_PIB_WAKEUP                                   (1u << 15) /* <15:15> RW:R:0:No */
...
/*
   This enables the characterization mode. Block SLB memories are configured
   as FIFOs to allow characterization of interface AC timing parameters.
 */
#define CY_U3P_PIB_CHAR_MODE                                (1u << 28) /* <28:28> R:RW:0:No */
 ...
 */
#define CY_U3P_PIB_PLL_BYPASS                               (1u << 29) /* <29:29> R:RW:0:No */


/*
   Enable BIST mode for this block.  Works regardless of value of RESETN.
    When BIST_EN=1, only the BIST* registers are guaranteed to work in this
   block; behavior of the normal operating modes is undefined.  Only use
   this mode when the block is in reset or disabled.
 */
#define CY_U3P_PIB_BIST_EN                                  (1u << 30) /* <30:30> R:RW:0:No */
...
/*
   Test Mode Control Register (PIB RAMs)
 */
#define CY_U3P_PIB_SRAM_CONTROL_ADDRESS                     (0xe0017f08)
#define CY_U3P_PIB_SRAM_CONTROL                             (*(uvint32_t *)(0xe0017f08))
#define CY_U3P_PIB_SRAM_CONTROL_DEFAULT                     (0x00000000)

/*
   Read margin control for Faraday DP memories, effective only when FCDP_DVSE=1
   0 - Loosest Margin
   15 - Tightest Margin
 */
#define CY_U3P_PIB_FCDP_DVS_MASK                            (0x0000000f) /* <0:3> R:RW:0:No */
#define CY_U3P_PIB_FCDP_DVS_POS                             (0)


/*
   Read margin adjustment enable for Faraday compiler generated dual port
   rams. Active high enable. Affects all dual port RAMs in this block.
   0: Normal operation with default sense amp read margins.
   1: Sense amp read margin adjustment enabled ontrolled by FCDP_DVS[3:0]
 */
#define CY_U3P_PIB_FCDP_DVSE                                (1u << 4) /* <4:4> R:RW:0:No */


/*
   Read margin control for Faraday SP memories, effective only when FCSP_DVSE=1
   0 - Loosest Margin
   15 - Tightest Margin
 */
#define CY_U3P_PIB_FCSP_DVS_MASK                            (0x00000f00) /* <8:11> R:RW:0:No */
#define CY_U3P_PIB_FCSP_DVS_POS                             (8)


/*
   Read margin adjustment enable. Active high enable. Affects all Faraday
   compiler generated single port RAMs in this block.
   0: Normal operation with default sense amp read margins.
   1: Sense amp read margin adjustment enabled ontrolled by FCSP_DVS[3:0]
 */
#define CY_U3P_PIB_FCSP_DVSE                                (1u << 12) /* <12:12> R:RW:0:No */
 ...
 */
#define CY_U3P_PIB_ADAPTER_DEBUG_ADDRESS                    (0xe001fff4)
#define CY_U3P_PIB_ADAPTER_DEBUG                            (*(uvint32_t *)(0xe001fff4))
#define CY_U3P_PIB_ADAPTER_DEBUG_DEFAULT                    (0x00000000)

/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_TS_COUNT_MASK                            (0x0000000f) /* <0:3> RW:R:0:N/A */
#define CY_U3P_PIB_TS_COUNT_POS                             (0)


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_TS_STATE_MASK                            (0x00000070) /* <4:6> RW:R:0:N/A */
#define CY_U3P_PIB_TS_STATE_POS                             (4)


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_TS_ID_MASK                               (0x00001f80) /* <7:12> RW:R:0:N/A */
#define CY_U3P_PIB_TS_ID_POS                                (7)


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_SS_COUNT_MASK                            (0x003fe000) /* <13:21> RW:R:0:N/A */
#define CY_U3P_PIB_SS_COUNT_POS                             (13)


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_SS_STATE                                 (1u << 22) /* <22:22> RW:R:0:N/A */


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_SS_ID_MASK                               (0x1f800000) /* <23:28> RW:R:0:N/A */
#define CY_U3P_PIB_SS_ID_POS                                (23)


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_TS_ABORT                                 (1u << 29) /* <29:29> RW:R:0:N/A */


/*
   Internal adapter state for debug observation
 */
#define CY_U3P_PIB_BS_STATE_MASK                            (0xc0000000) /* <30:31> RW:R:0:N/A */
#define CY_U3P_PIB_BS_STATE_POS                             (30)
 ...
 */
#define CY_U3P_PIB_ADAPTER_CONF_ADDRESS                     (0xe001fff8)
#define CY_U3P_PIB_ADAPTER_CONF                             (*(uvint32_t *)(0xe001fff8))
#define CY_U3P_PIB_ADAPTER_CONF_DEFAULT                     (0x00000000)

/*
   Number of words in a socket fetch queue (FQ) that must be present before
   sck_active asserts.  Default value is FQ_SIZE, which means the entire
   FQ must fill up before sck_active asserts.
 */
#define CY_U3P_PIB_FQ_THRESHOLD_MASK                        (0x0000003f) /* <0:5> R:RW:H:N/A */
#define CY_U3P_PIB_FQ_THRESHOLD_POS                         (0)


/*
   Number of burst requests to issue without examining the FQ depth (because
   IP Core can guarantee immediate consumption).
 */
#define CY_U3P_PIB_STREAM_COUNT_MASK                        (0x00007fc0) /* <6:14> R:RW:0:N/A */
#define CY_U3P_PIB_STREAM_COUNT_POS                         (6)


/*
   0: Do not make fetch requests unless fetch queue has space to hold response
   (default).
   1: Assume IP Core will drain all data as it comes in.  Place fetch requests
   on bus as fast as possible (DO NOT USE UNLESS YOU KNOW WHAT YOU ARE DOING).
 */
#define CY_U3P_PIB_STREAMING_MODE                           (1u << 15) /* <15:15> R:RW:0:N/A */


/*
   Minimum cycles between prefetch requests to the bus.  The adapter will
   wait for this number of cycles in between prefetch burst requests when
   activating a descriptor on a socket.  If TS_CYCLES=0, the requests will
   be sent back-to-back (assuming queues are not full).
 */
#define CY_U3P_PIB_TS_CYCLES_MASK                           (0x000f0000) /* <16:19> R:RW:0:N/A */
#define CY_U3P_PIB_TS_CYCLES_POS                            (16)


/*
   Minimum cycles between fetch requests to the bus under normal operation.
    The adapter will wait for this number of cycles in between burst requests
   when refilling a fetch queue for a desriptor  If ES_CYCLES=0, the requests
   may be sent back-to-back (assuming queues are not full).
 */
#define CY_U3P_PIB_ES_CYCLES_MASK                           (0x00f00000) /* <20:23> R:RW:0:N/A */
#define CY_U3P_PIB_ES_CYCLES_POS                            (20)


/*
   Minimum cycles between any fetch requests to the bus.  The adapter will
   wait for this number of cycles in between any fetch or prefetch burst
   requests when activating a descriptor on a socket.  If GBL_CYCLES=0, the
   requests may be sent back-to-back (assuming queues are not full).
 */
#define CY_U3P_PIB_GBL_CYCLES_MASK                          (0x0f000000) /* <24:27> R:RW:0:N/A */
#define CY_U3P_PIB_GBL_CYCLES_POS                           (24)


/*
   Sets priority between MMIO and Core requests:
   0: fair arbitration. MMIO is guaranteed to win the next cycle if there
   was a collision with the core request in the first cycle.
   1: low priority. MMIO will never win if the core has a request.
 */
#define CY_U3P_PIB_MMIO_LOW_PRIORITY                        (1u << 28) /* <28:28> R:RW:0:N/A */


/*
   Socket swicth higher priority than interconnect
 */
#define CY_U3P_PIB_SWITCH_HIGH_PRIORITY                     (1u << 29) /* <29:29> R:RW:0:N/A */


/*
   Allow TS to be aborted
 */
#define CY_U3P_PIB_TS_ABORT_EN                              (1u << 30) /* <30:30> R:RW:0:N/A */
 ...
 */
#define CY_U3P_PIB_ADAPTER_STATUS_ADDRESS                   (0xe001fffc)
#define CY_U3P_PIB_ADAPTER_STATUS                           (*(uvint32_t *)(0xe001fffc))
#define CY_U3P_PIB_ADAPTER_STATUS_DEFAULT                   (0x00000000)

/*
   Total number of sockets in this adapter.  This number is different for
   each instance of the adapter and varies with the core IP needs.
 */
#define CY_U3P_PIB_TTL_SOCKETS_MASK                         (0x000000ff) /* <0:7> RW:R:H:N/A */
#define CY_U3P_PIB_TTL_SOCKETS_POS                          (0)
 ...
 */
#define CY_U3P_PIB_IG_ONLY_MASK                             (0x0000ff00) /* <8:15> RW:R:H:N/A */
#define CY_U3P_PIB_IG_ONLY_POS                              (8)


/*
   Number of words in a socket fetch queue (FQ).  The total buffer space
   in the adapter is EG_SOCKETS*FQ_SIZE words of size WORD_SIZE.
 */
#define CY_U3P_PIB_FQ_SIZE_MASK                             (0x003f0000) /* <16:21> RW:R:H:N/A */
#define CY_U3P_PIB_FQ_SIZE_POS                              (16)


/*
   Internal word size of the prefetch queue (FQ); not the same as bus width
   of AHB bus or thread interface to the IP.
   0: 32b
   1: 64b
   2: 128b
   3: 256b
 */
#define CY_U3P_PIB_WORD_SIZE_MASK                           (0x00c00000) /* <22:23> RW:R:H:N/A */
#define CY_U3P_PIB_WORD_SIZE_POS                            (22)
