  ...
  OpenOCD binary for MacOS
  ------------------------

  This folder provides an openocd binary for 64-bit Intel based MacOS
  ...
  2. libusb-1.0 library: This is the standard LibUsb-1.0 library compiled
     for MacOS. The latest version of libusb-1.0 can be downloaded from
