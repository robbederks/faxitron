/*
 ## Cypress USB 3.0 Platform header file (cyfxusbotg.h)
 ## ===========================
 ##
...
#define CY_FX_OTG_VBUS_ENABLE_VALUE    (CyTrue)                         /* GPIO value for driving VBUS. */
#define CY_FX_OTG_VBUS_DISABLE_VALUE   (!CY_FX_OTG_VBUS_ENABLE_VALUE)   /* GPIO value for disabling VBUS. */
...
/* Summary
   ...
   Description
   The function stops the mouse driver application and disables
   the USB host module.
 */
extern void
CyFxUsbHostStop (
