/*
 ## Cypress USB 3.0 Platform header file (cyfxbulklpmanualadd.h)
 ## ===========================
 ##
...
#ifndef _INCLUDED_CYFXBULKLPMANUAL_ADD_H_
#define _INCLUDED_CYFXBULKLPMANUAL_ADD_H_
...
#define CY_FX_DMA_HEADER_SIZE           (4)     /* Size of the header to be added to received data. */
#define CY_FX_DMA_FOOTER_SIZE           (4)     /* Size of the footer to be added to received data. */

#define CY_FX_HEADER_DATA               (0x55)  /* Byte of data to be repeated as header. */
#define CY_FX_FOOTER_DATA               (0xAA)  /* Byte of data to be repeated as footer. */
...
#endif /* _INCLUDED_CYFXBULKLPMANUAL_ADD_H_ */
