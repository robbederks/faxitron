/*
 ## Cypress USB 3.0 Platform header file (cyfxbulklpmanualrem.h)
 ## ===========================
 ##
...
#ifndef _INCLUDED_CYFXBULKLPMANUAL_REM_H_
#define _INCLUDED_CYFXBULKLPMANUAL_REM_H_
...
#endif /* _INCLUDED_CYFXBULKLPMANUAL_REM_H_ */
