 ...
 * uses dynamically allocated buffers for USB descriptors. This is not the only pre-requisite
 * to enabling the D-cache. Refer to the documentation for CyU3PDeviceCacheControl for more
 * information. */
