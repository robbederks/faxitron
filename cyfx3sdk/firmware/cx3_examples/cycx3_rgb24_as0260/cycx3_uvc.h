...
/* Uncomment the following to enable a timer that stops and restarts streaming if a frame
 * gets stuck. The default setting is timer enabled.
 */
#define RESET_TIMER_ENABLE                     (1)

#ifdef RESET_TIMER_ENABLE
#define TIMER_PERIOD                           (500)            /* Maximum duration for the transfer of a frame (in milli-seconds) */
#endif
...
#define CX3_APP_DATA_BUF_SIZE                   (0x8FD0)        /* DMA Buffer Data Size Used: 36816 Bytes*/
...
#define CX3_APP_MAX_PROBE_SETTING_ALIGNED       (32)    /* Probe control size aligned to 32 bytes. */
#else
#define CX3_APP_MAX_PROBE_SETTING               (34)    /* UVC 1.1 Maximum number of bytes in Probe Control */
#define CX3_APP_MAX_PROBE_SETTING_ALIGNED       (64)    /* Probe control size aligned to 32 bytes. */
#endif
...
/* Event to signal that a frame timeout occurred. */
...
#define CX3_GPIF_SWITCH_TIMEOUT                 (2)             /* GPIF switch operation timeout. */
