...
/* This header file comprises of the application constants and
 * the video frame configurations */

/* Uncomment the following line to provide verbose debug logging. */
/* #define CX3_DEBUG_ENABLED                    (1) */

/* Uncomment the following line to run using UVC 1.0.
 * Default is UVC 1.1 device.
 */
/* #define CX3_UVC_1_0_SUPPORT                  (1)  */

/* Uncomment the following to enable a timer that aborts video frames if they take too
 * long to transfer. Default is timer enabled.
 */
#define RESET_TIMER_ENABLE                      (1)

#ifdef RESET_TIMER_ENABLE
#define TIMER_PERIOD                            (500)           /* Maximum duration allowed for one video frame to be completed. */
#endif
...
#define CX3_EP_BULK_SUPER_SPEED_BURST_LEN       (12)    /* Super Speed endpoint burst length */
...
#define CX3_APP_DATA_BUF_SIZE                   (0x2FF0)        /* DMA Buffer Data Size Used: 12272 Bytes*/
#define CX3_APP_PROD_HEADER                     (12)            /* UVC DMA Buffer Header Size */
#define CX3_APP_PROD_FOOTER                     (4)             /* UVC DMA Buffer Footer Size */
...
/* UVC Buffer count */
#define CX3_APP_STREAM_BUF_COUNT                (8)
...
#define CX3_APP_HEADER_DEFAULT_BFH              (0x8C)                  /* Default BFH for the UVC Header */

#ifdef CX3_UVC_1_0_SUPPORT
#define CX3_APP_MAX_PROBE_SETTING               (26)            /* UVC 1.0 Maximum number of bytes in Probe Control */
#define CX3_APP_MAX_PROBE_SETTING_ALIGNED       (32)            /* Probe control size aligned to a multiple of 32. */
#else
#define CX3_APP_MAX_PROBE_SETTING               (34)            /* UVC 1.1 Maximum number of bytes in Probe Control */
#define CX3_APP_MAX_PROBE_SETTING_ALIGNED       (64)            /* Probe control size aligned to a multiple of 32. */
#endif
...
#define CX3_GPIF_SWITCH_TIMEOUT                 (2)             /* Timeout setting for the GPIF switch operation */
...
extern const uint8_t gl720pProbeCtrl[];
extern const uint8_t gl1080pProbeCtrl[];
extern const uint8_t glQvga90ProbeCtrl[];
extern const uint8_t glVga60ProbeCtrl[];
extern const uint8_t glVga30ProbeCtrl[];
extern const uint8_t glQvga5ProbeCtrl[];

/************************************/
/* MIPI Configuration parameters */
/************************************/

extern CyU3PMipicsiCfg_t cfgUvc1080p30NoMclk, cfgUvc720p60NoMclk, cfgUvcQvgaNoMclk, cfgUvcVgaNoMclk;
