...
const uint8_t CyCx3USBSSConfigDscr[] =
{
    ...
    0xFE, 0x00,                         /* Length of this descriptor and all sub descriptors */
...
const uint8_t CyCx3USBHSConfigDscr[] =
{
    ...
    CY_U3P_USB_CONFIG_DESCR,            /* Configuration descriptor type */
#ifdef CX3_UVC_1_0_SUPPORT
    0x0F,0x01,                          /* Length of this descriptor and all sub descriptors */
#else
    0x10,0x01,                          /* Length of this descriptor and all sub descriptors */
#endif
    0x02,                               /* Number of interfaces */
    0x01,                               /* Configuration number */
    ...
    0x01,                               /* Descriptor subtype : Input Header */
    0x01,                               /* 1 format desciptor follows */
    0x89, 0x00,                         /* Total size of class specific VS descr */
    CX3_EP_BULK_VIDEO,                  /* EP address for BULK video data: EP 3 IN  */
    0x00,                               /* No dynamic format change supported */
    0x04,                               /* Output terminal ID : 4 */
    0x00,                               /* No Still image capture method supported */
    ...
    /* Class specific Uncompressed VS frame descriptor 1 - 640x480@30fps */
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    0x01,                               /* Frame Descriptor Index: 1 */
    ...
    /* Class specific Uncompressed VS Frame Descriptor 3 - 320x240@90fps */
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
...
/* UVC Probe Control Setting - VGA @30 fps (High Speed)*/
...
uint8_t const glQvga5ProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    ...
    0x00, 0x00,                         /* Window size for average bit rate */
    0x00, 0x00,                         /* Internal video streaming i/f latency in ms */
    0x00, 0x58, 0x02, 0x00,             /* Max video frame size in bytes: 320 x 240 x 2 = 0x25800 */
#ifdef CX3_UVC_1_0_SUPPORT
    0x00, 0x40, 0x00, 0x00              /* No. of bytes device can rx in single payload: 16 KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
