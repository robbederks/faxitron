/*
 ## Cypress CX3 Firmware Example Source (cycx3_dscr.c)
 ## ===========================
 ##
...
/* This file contains the USB enumeration descriptors for the CX3 RGB16 (RGB565) application example.
...
const uint8_t CyCx3USBHSConfigDscr[] =
{
    ...
    CY_U3P_USB_CONFIG_DESCR,            /* Configuration descriptor type */
#ifdef CX3_UVC_1_0_SUPPORT
    0x09,0x01,                          /* Length of this descriptor and all sub descriptors */
#else
    0x0A,0x01,                          /* Length of this descriptor and all sub descriptors */
#endif
    0x02,                               /* Number of interfaces */
    0x01,                               /* Configuration number */
    ...
    0xAF, 0x0B, 0xA7, 0x70,
    0x10,                               /* Number of bits per pixel: 16*/
    0x01,                               /* Optimum Frame Index for this stream: 1 (VGA 30fps) */
    0x00,                               /* X dimension of the picture aspect ratio; Non-interlaced */
    0x00,                               /* Y dimension of the pictuer aspect ratio: Non-interlaced */
    0x00,                               /* Interlace Flags: Progressive scanning, no interlace */
    0x00,                               /* duplication of the video stream restriction: 0 - no restriction */
    ...
    /* Class specific Uncompressed VS frame descriptor 2 - 640 x 480 @ 60 fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    0x02,                               /* Frame Descriptor Index: 2 */
    ...
    /* Class specific Uncompressed VS Frame Descriptor 3 - 320 x 240 @ 90 fps */
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    ...
    0x00, 0x80, 0x97, 0x06,             /* Min bit rate (bits/s): 320 x 240 x 2 x 90 x 8 = 110592000 */
    0x00, 0x80, 0x97, 0x06,             /* Max bit rate (bits/s): Fixed rate so same as Min  */
    0x00, 0x58, 0x02, 0x00,             /* Maximum video or still frame size in bytes(Deprecated): 320 x 240 x 2*/
    0x07, 0xB2, 0x01, 0x00,             /* Default frame interval (in 100ns units): (1/90)x10^7 */
    0x01,                               /* Frame interval type : No of discrete intervals */
    ...
    CX3_EP_BULK_VIDEO,                  /* Endpoint address and description: EP 3 IN */
    CY_U3P_USB_EP_BULK,                 /* BULK End point */
    0x00, 0x02,                         /* Packet Size: 512 bytes */
    0x00                                /* Servicing interval for data transfers */
};
...
const uint8_t CyCx3USBFSConfigDscr[] =
{
    ...
    CX3_EP_BULK_VIDEO,                  /* Endpoint address and description: EP 3 IN */
    CY_U3P_USB_EP_BULK,                 /* BULK End point */
    0x40, 0x00,                         /* EP Packet Size: 64 bytes */
    0x00                                /* Servicing interval for data transfers */
};
...
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x40, 0x00, 0x00              /* No. of bytes device can rx in single payload: 16KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
    0x00, 0x40, 0x00, 0x00,             /* No. of bytes device can rx in single payload: 16KB */
    0x00, 0x60, 0xE3, 0x16,             /* Device Clock */
...
uint8_t const glQvga90ProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    ...
    0x07, 0xB2, 0x01, 0x00,             /* Desired frame interval in 100ns = (1/90)x10^7 */
    0x00, 0x00,                         /* Key frame rate in key frame/video frame units */
    0x00, 0x00,                         /* PFrame rate in PFrame / key frame units */
    0x00, 0x00,                         /* Compression quality control */
    0x00, 0x00,                         /* Window size for average bit rate */
...
/* UVC Probe Control Setting - QVGA @5 fps (Full Speed)*/
uint8_t const glQvga5ProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
    0x01,                               /* Use 1st Video frame index */
    0x40, 0x4B, 0x4C, 0x00,             /* Desired frame interval in 100ns = (1/5)x10^7 */
    0x00, 0x00,                         /* Key frame rate in key frame/video frame units */
    0x00, 0x00,                         /* PFrame rate in PFrame / key frame units */
    0x00, 0x00,                         /* Compression quality control */
    0x00, 0x00,                         /* Window size for average bit rate */
    0x00, 0x00,                         /* Internal video streaming i/f latency in ms */
    0x80, 0x84, 0x1E, 0x00,             /* Max video frame size in bytes: 320 x 240 x 2*/
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x40, 0x00, 0x00              /* No. of bytes device can rx in single payload: 16KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
