...
/* This file contains the USB enumeration descriptors for the CX3 RGB 24 (RGB565 unpacked over 24 bits)
...
const uint8_t CyCx3USBSSConfigDscr[] =
{
    ...
    0x00, 0x40, 0xFD, 0x58,             /* Min bit rate (bits/s): 1080 x 1920 x 3 x 30 x 8 = 1492992000 */
    0x00, 0x40, 0xFD, 0x58,             /* Max bit rate (bits/s): Fixed rate so same as Min */
    ...
    0x00, 0x80, 0x82, 0x48,             /* Min bit rate @55fps (bits/s): 720 x 1280 x 3 x 55 x 8 = 1216512000 */
    ...
    /* Class specific Uncompressed VS frame descriptor 3 - 640x480@60fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    ...
    0x00, 0x00, 0x5E, 0x1A,             /* Min bit rate (bits/s): 640 x 480 x 3 x 60 x 8 = 442368000 */
    0x00, 0x00, 0x5E, 0x1A,             /* Max bit rate (bits/s): Fixed rate so same as Min  */
    0x00, 0x10, 0x0E, 0x00,             /* Maximum video or still frame size in bytes(Deprecated): 640 x 480 x 3*/
    0x0A, 0x8B, 0x02, 0x00,             /* Default frame interval (in 100ns units): 166666 */
    0x01,                               /* Frame interval type : No of discrete intervals */
    0x0A, 0x8B, 0x02, 0x00,             /* Frame interval 3: Same as Default frame interval */
    ...
    0x06,                               /* Descriptor size */
    CY_U3P_SS_EP_COMPN_DESCR,           /* SS Endpoint Companion Descriptor Type */
    0x0B,                               /* Max number of packets per burst: 12 */
...
const uint8_t CyCx3USBHSConfigDscr[] =
{
    ...
    0xAF, 0x0B, 0xA7, 0x70,
    0x18,                               /* Number of bits per pixel: 24 */
    0x02,                               /* Optimum Frame Index for this stream: 2 (QVGA 90 fps) */
    0x00,                               /* X dimension of the picture aspect ratio; Non-interlaced */
    0x00,                               /* Y dimension of the pictuer aspect ratio: Non-interlaced */
    0x00,                               /* Interlace Flags: Progressive scanning, no interlace */
    0x00,                               /* duplication of the video stream restriction: 0 - no restriction */
    ...
    0x00, 0xA0, 0x8C, 0x00,             /* Min bit rate (bits/s): 320 x 240 x 3 x 5 x 8 = 9216000 */
    0x00, 0xA0, 0x8C, 0x00,             /* Max bit rate (bits/s): Fixed rate so same as Min  */
    0x00, 0x84, 0x03, 0x00,             /* Maximum video or still frame size in bytes(Deprecated): 320 x 240 x 3*/
    0x80, 0x84, 0x1E, 0x00,             /* Default frame interval (in 100ns units): 2000000 */
    0x01,                               /* Frame interval type : No of discrete intervals */
    0x80, 0x84, 0x1E, 0x00,             /* Frame interval 3: Same as Default frame interval */

    /* Class specific Uncompressed VS Frame Descriptor 2 - 320 x 240 @ 90fps */
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    0x02,                               /* Frame Descriptor Index: 2 */
    ...
    0x40, 0x01,                         /* Width in pixel:  320 */
    0xF0, 0x00,                         /* Height in pixel: 240 */
    0x00, 0x40, 0xE3, 0x09,             /* Min bit rate (bits/s): 320 x 240 x 3 x 90 x 8 = 165888000 */
    0x00, 0x40, 0xE3, 0x09,             /* Max bit rate (bits/s): Fixed rate so same as Min  */
    0x00, 0x84, 0x03, 0x00,             /* Maximum video or still frame size in bytes(Deprecated): 320 x 240 x 3*/
    0x07, 0xB2, 0x01, 0x00,             /* Default frame interval (in 100ns units): 111111 */
    0x01,                               /* Frame interval type : No of discrete intervals */
...
const uint8_t CyCx3USBFSConfigDscr[] =
{
    ...
    0xAF, 0x0B, 0xA7, 0x70,
    0x18,                               /* Number of bits per pixel: 24*/
    0x01,                               /* Optimum Frame Index for this stream: 1 (320 x 240 5 fps) */
    0x00,                               /* X dimension of the picture aspect ratio; Non-interlaced */
    0x00,                               /* Y dimension of the pictuer aspect ratio: Non-interlaced */
    0x00,                               /* Interlace Flags: Progressive scanning, no interlace */
    0x00,                               /* duplication of the video stream restriction: 0 - no restriction */
    ...
    0x40, 0x01,                         /* Width in pixel:  320 */
    0xF0, 0x00,                         /* Height in pixel: 240 */
    0x00, 0x40, 0x38, 0x00,             /* Min bit rate (bits/s): 320 x 240 x 3 x 2 x 8 = 3686400 */
    0x00, 0x40, 0x38, 0x00,             /* Max bit rate (bits/s): Fixed rate so same as Min  */
    0x00, 0x84, 0x03, 0x00,             /* Maximum video or still frame size in bytes(Deprecated): 320 x 240 x 3*/
    0x40, 0x4B, 0x4C, 0x00,             /* Default frame interval (in 100ns units): 5000000 */
    0x01,                               /* Frame interval type : No of discrete intervals */
...
uint8_t glProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    ...
    0x00, 0xEC, 0x5E, 0x00,             /* Max video frame size in bytes */ 
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x80, 0x00, 0x00              /* No. of bytes device can rx in single payload: 12KB */
#else
...
uint8_t const gl1080pProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    ...
    0x00, 0x00,                         /* Window size for average bit rate */
    0x00, 0x00,                         /* Internal video streaming i/f latency in ms */
    0x00, 0xEC, 0x5E, 0x00,             /* Max video frame size in bytes = 1920 x 1080 x 3 */ 
#ifdef CX3_UVC_1_0_SUPPORT 
...
uint8_t const gl720pProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    ...
    0x00, 0x00,                         /* Window size for average bit rate */
    0x00, 0x00,                         /* Internal video streaming i/f latency in ms */
    0x00, 0x30, 0x2A, 0x00,             /* Max video frame size in bytes: 720 x 1280 x 3*/
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x90, 0x00, 0x00              /* No. of bytes device can rx in single payload: 36KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
...
uint8_t const glVga60ProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
    0x03,                               /* Use 3rd Video frame index */
    0x0A, 0x8B, 0x02, 0x00,             /* Desired frame interval in 100ns = 166666 */
    0x00, 0x00,                         /* Key frame rate in key frame/video frame units */
    0x00, 0x00,                         /* PFrame rate in PFrame / key frame units */
    0x00, 0x00,                         /* Compression quality control */
    0x00, 0x00,                         /* Window size for average bit rate */
    0x00, 0x00,                         /* Internal video streaming i/f latency in ms */
    0x00, 0x10, 0x0E, 0x00,             /* Max video frame size in bytes: 640 x 480 x 3*/
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x90, 0x00, 0x00              /* No. of bytes device can rx in single payload: 36KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
...
/* UVC Probe Control Setting - QVGA@90fps (High Speed)*/
uint8_t const glQvga90ProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
    0x02,                               /* Use 2nd Video frame index */
    0x07, 0xB2, 0x01, 0x00,             /* Desired frame interval in 100ns = 111111 */
    0x00, 0x00,                         /* Key frame rate in key frame/video frame units */
    0x00, 0x00,                         /* PFrame rate in PFrame / key frame units */
    0x00, 0x00,                         /* Compression quality control */
    0x00, 0x00,                         /* Window size for average bit rate */
    0x00, 0x00,                         /* Internal video streaming i/f latency in ms */
    0x00, 0x84, 0x03, 0x00,             /* Max video frame size in bytes: 320 x 240 x 3*/
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x90, 0x00, 0x00              /* No. of bytes device can rx in single payload: 36KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
...
/* UVC Probe Control Setting - QVGA @5 fps (High/Full Speed) */
uint8_t const glQvga5ProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
    0x01,                               /* Use 1st Video frame index */
    0x40, 0x4B, 0x4C, 0x00,             /* Desired frame interval in 100ns = 2000000 */
    0x00, 0x00,                         /* Key frame rate in key frame/video frame units */
    0x00, 0x00,                         /* PFrame rate in PFrame / key frame units */
    0x00, 0x00,                         /* Compression quality control */
    0x00, 0x00,                         /* Window size for average bit rate */
    ...
    0x00, 0x84, 0x03, 0x00,             /* Max video frame size in bytes: 320 x 240 x 3*/
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x90, 0x00, 0x00              /* No. of bytes device can rx in single payload: 16KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
    0x00, 0x90, 0x00, 0x00,             /* No. of bytes device can rx in single payload: 16KB */
    0x00, 0x60, 0xE3, 0x16,             /* Device Clock */
...
/* Configuration parameters for 1080p @30FPS for the As0260 sensor */
...
/* Configuration parameters for 720p @60FPS for the As0260 sensor */
...
/* Configuration parameters for QVGA for the As0260 sensor */
CyU3PMipicsiCfg_t cfgUvcQvgaNoMclk =  { 
    CY_U3P_CSI_DF_RGB565_1, 
    2, 
    0x2, 
    89, 
...
/* Configuration parameters for VGA for the As0260 sensor */
