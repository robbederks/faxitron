/*
 ## Cypress FX3S Example Application Source File (cymsc_dscr.c)
 ## ===========================
 ##
...
/* This file contains the USB descriptors for the MSC application example */
...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    CY_FX_RAID_EP_BURST_SIZE - 1,   /* Max no. of packets in a Burst. */
