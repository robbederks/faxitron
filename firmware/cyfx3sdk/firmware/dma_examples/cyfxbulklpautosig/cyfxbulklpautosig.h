/*
 ## Cypress USB 3.0 Platform header file (cyfxbulklpautosig.h)
 ## ===========================
 ##
...
#ifndef _INCLUDED_CYFXBULKLPAUTOSIG_H_
#define _INCLUDED_CYFXBULKLPAUTOSIG_H_
...
#endif /* _INCLUDED_CYFXBULKLPAUTOSIG_H_ */
