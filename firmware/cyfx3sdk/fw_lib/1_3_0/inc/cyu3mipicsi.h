/*
## Cypress USB 3.0 Platform header file (cyu3mipicsi.h)
## ===========================
##
...
/** \file cyu3mipicsi.h
    ...
    structures, functions and macros for CX3 devices. This release provides
    BETA level support for the CX3 devices.
*/
...
#define CX3_START                       0       
#define CX3_IDLE                        1
#define CX3_WAIT_FOR_FRAME_START        2
#define CX3_PUSH_DATA_TO_SCK0           3
#define CX3_PUSH_DATA_TO_SCK1           4
...
#define CX3_ALPHA_START                 0x0     /**< Initial value of early outputs from the CX3 GPIF state machine. */

#define CX3_NUMBER_OF_STATES            13      /**< Number of states in the CX3 GPIF state machine */
...
typedef struct CyU3PMipicsiCfg_t
{
    ...
    uint16_t mClkCtl;                       /**< Settings used to generate MCLK output clock (to provide 
                                                 Reference clock to the attached Image Sensor). 
    ...
    CyU3PMipicsiPllClkFrs_t pllFrs;         /**< Frequency Range Setting*/
    
    CyU3PMipicsiPllClkDiv_t ppiClkDiv;      /**< Clock divider for clock used for detecting 
                                                 CSI Link LP<->HS transitions*/
    
    CyU3PMipicsiPllClkDiv_t mClkRefDiv;     /**< Clock divider used for generating the MCLK */
    
    CyU3PMipicsiPllClkDiv_t sClkDiv;        /**< Clock divider used for generating the PCLK used for clocking the 
...
CyU3PMipicsiGpifLoad (
        ...
        uint32_t bufferSize                     /**< Set Data counter based on DMA buffer size being used. 
                                                     ...
                                                     being used i.e. (The size being passed to the CyU3PDmaChannelCreate API) - (The Size of Header and Footer)
                                                     e.g. If dmaCfg is CyU3PDmaChannelConfig_t object being passed to the ChannelCreate API
                                                     the value of bufferSize = dmaCfg.size - (dmaCfg.prodHeader + dmaCfg.prodFooter) */
