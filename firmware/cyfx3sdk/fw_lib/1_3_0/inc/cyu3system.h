...
/** \brief Log a codified message.
    ...
    **Description**\n
    ...
    out to the UART when it is full. The CyU3PDebugLogFlush can be used to flush
    the contents of the log buffer to the UART. The CyU3PDebugLogClear can be used
    to clear the contents of the log buffer.
