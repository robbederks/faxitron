/*
 ## Cypress USB 3.0 Platform header file (cyfxapidesc.h)
 ## ===========================
 ##
...
/** \mainpage EZ-USB FX3 Api Reference Guide
    ...
    **Description**\n
    ...
    Image Sensors implementing the MIPI CSI-2 interface. BETA support for CX3 devices
    is available in this release of the SDK.
    ...
    **Description**\n
    ...
    This SDK release provides BETA level API support for configuring and utilizing the MIPI-CSI2 interface 
