/*
 ## Cypress USB 3.0 Platform header file (cyfxusbdscr.c)
 ## ===========================
 ##
...
/* This file contains the USB enumeration descriptors for the debug application example.
...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) = {
  ...
  0x07,                           /* Descriptor size */
  CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
  CY_FX_EP_UART_PRODUCER,         /* Endpoint address and description */
  CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
  0x00,0x04,                      /* Max packet size = 1024 bytes */
  0x00,                           /* Servicing interval for data transfers : 0 for bulk */
  ...
  0x07,                           /* Descriptor size */
  CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
  CY_FX_EP_UART_CONSUMER,         /* Endpoint address and description */
  CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
  0x00,0x04,                      /* Max packet size = 1024 bytes */
  0x00,                           /* Servicing interval for data transfers : 0 for Bulk */
...
const uint8_t CyFxUSBHSConfigDscr[] __attribute__ ((aligned (32))) = {
  ...
  0x09,                           /* Descriptor size */
  CY_U3P_USB_CONFIG_DESCR,        /* Configuration descriptor type */
  0x34,0x00,                      /* Length of this descriptor and all sub descriptors */
  0x01,                           /* Number of interfaces */
  0x01,                           /* Configuration number */
  0x00,                           /* Configuration string index */
  0x80,                           /* Config characteristics - bus powered */
  ...
  CY_FX_EP_DEBUG,                 /* Endpoint address and description */
  CY_U3P_USB_EP_INTR,             /* Interrupt endpoint type */
  0x80,0x00,                      /* Max packet size = 128 bytes */
  0x01,                           /* Servicing interval for data transfers : every micro-frame. */
  ...
  /* Endpoint descriptor for UART producer EP */
  0x07,                           /* Descriptor size */
  CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
  CY_FX_EP_UART_PRODUCER,         /* Endpoint address and description */
  CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
  ...
  /* Endpoint descriptor for UART consumer EP */
  0x07,                           /* Descriptor size */
  CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
  CY_FX_EP_UART_CONSUMER,         /* Endpoint address and description */
  CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
